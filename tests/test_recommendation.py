"""Lock in the 30c/L fill-now vs wait cutoff.

These numbers are the product rule, not an implementation detail. If they
change, the widget copy and tank-impact math change with them.
"""
