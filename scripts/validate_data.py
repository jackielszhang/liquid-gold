"""Guardrails before a payload is allowed to replace public/fuel-data.json.

Ranges exist so a parser glitch (R25.23 becoming 25230 cents, or a missing
coastal cell) cannot ship into the widget. A failed validation is a no-op
publish, not a quieter overwrite.
"""
