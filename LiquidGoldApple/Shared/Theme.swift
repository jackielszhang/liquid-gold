...
/// Apollo Utility tokens translated into SwiftUI colours.
///
/// Orange is a signal, not a theme. Hard offset shadows and 2px black borders
/// are the depth language; do not replace them with blur.
