...
/// Flattens the published JSON + the user's selection into UI-ready values.
///
/// The pipeline already computed next-price and recommendation copy. This
/// builder only picks the matching region/fuel, estimates tank impact, and
/// marks data older than 48 hours as stale.
public enum FuelSnapshotBuilder {
    ...
    public static func build(
        ...
        // Cents * litres / 100 = rands on the next fill if the forecast holds.
